"""Article 13 — 雷达怎么知道方向？ (ZH)."""

from manim import (
    Scene, VGroup, Dot, Rectangle, Line, Arrow, Text, Sector,
...
class RadarArticle13(Scene):
    def construct(self):
        ...
        radar_label = Text("雷达", color=TEAL, font_size=16, weight="BOLD")\
        ...
        target_label = Text("目标", color=YELLOW, font_size=14,
        ...
        step_label_3 = Text("3. 发现 — 波束命中目标，回波到达",
