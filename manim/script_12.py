...
Run:
    D:/Users/eddiewen/AppData/Local/Programs/Python/Python312/python.exe \\
        -m manim -ql script.py RadarArticle12
Output:
    media/videos/script/480p15/RadarArticle12.mp4
"""
...
class RadarArticle12(Scene):
    ...
    def construct(self):
        ...
        radar_label = Text(
            "\u96f7\u8fbe",
            font_size=22, color=RADAR_CYAN, weight="BOLD",
        ...
        target_label = Text(
            "\u98de\u673a",
            font_size=22, color=PLANE_YELLOW, weight="BOLD",
        ...
        # STEP 2: TRAVEL (already shown in step 1, but highlight)
        step_label.become(
            Text("2. \u4f20\u64ad", font_size=30, color=WAVE_GREEN, weight="BOLD")
            .move_to([0, 2.6, 0])
        )
        self.wait(0.2)
        ...
        # STEP 3: ECHO
        step_label.become(
            Text("3. \u56de\u6ce2", font_size=30, color=ECHO_RED, weight="BOLD")
            .move_to([0, 2.6, 0])
        )
        self.wait(0.2)

        self.play(FadeIn(wave_back), run_time=0.3)
        # echo tick slides from t/2 to t along the time axis
        ...
        # STEP 4: COMPUTE
        step_label.become(
            Text("4. \u8ba1\u7b97", font_size=30, color=YELLOW, weight="BOLD")
            .move_to([0, 2.6, 0])
        )
        self.wait(0.2)
